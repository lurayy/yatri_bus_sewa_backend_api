...
class Booking(models.Model):
    ...
    vehicle = models.ForeignKey(VehicleItem, on_delete = models.SET_NULL, null = True)   # for ease of info extraction i.e bus number


class Seat(models.Model):
    ''' Seat linked to the active vehicle instance and is created dynamically using information for VehicleType'''
    vehicle = models.ForeignKey(VehicleItem, on_delete = models.CASCADE)
